 ...
 * 
 * @author Mahesh
 * This class will store all the WebDriver operation
 * Here we will perform the Reusable methods Which will help in optimize your code
 */
...
public class Webdriverutils {
	 ...
	 * @param driver it will store the id of current page
	 */
	public void multiele( String matchingdata,List<WebElement> mulele)
	{
